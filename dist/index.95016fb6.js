...
})({"3pPec":[function(require,module,exports) {
"use strict";
...
async function getProduct() {
    ...
    const { data  } = await (0, _axiosDefault.default).get(`https://rolex-shopping.herokuapp.com/api/v1/products`);
    newProductArea.innerHTML = "";
    data?.products.slice(0, 4).map((product)=>generateMarkUp(product));
}
window.addEventListener("load", getProduct);

},{"phosphor-icons":"kD0cd","axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kD0cd":[function(require,module,exports) {
...
},{}]},["3pPec","al9TC"], "al9TC", "parcelRequire0ffd")
